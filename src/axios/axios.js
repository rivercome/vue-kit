...
//   "application/x-www-form-urlencoded"; //请求type设置
...
//       config.headers.common["singlesignonaegiscookietoken"] =
//         localStorage.getItem("SingleSignOnAegisAegisTicket");
...
//       store.state.logStatus.changeLoginVisable != true
//     ) {
//       let loginUrl = error.response.headers.singlesignonaegisheaderloginurl;
//       let notLogin = error.response.headers.singlesignonaegisheadernotlogin;
//       if (num == 1) {
